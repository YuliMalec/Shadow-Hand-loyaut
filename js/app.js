(() => {
    ...
    function initSliders() {
        if (document.querySelector(".ability__slider.swiper")) new swiper_core_Swiper(".ability__slider.swiper", {
            modules: [ Navigation ],
            observer: true,
            observeParents: true,
            slidesPerView: 6,
        ...
        if (document.querySelector(".reviews__slider.swiper")) new swiper_core_Swiper(".reviews__slider.swiper", {
            modules: [ Navigation ],
            observer: true,
            observeParents: true,
            slidesPerView: 2,
            ...
            preloadImages: false,
            navigation: {
                prevEl: ".arr-prev.arrow",
                nextEl: ".arr-next.arrow",
                clickable: true
            },
            breakpoints: {
                360: {
